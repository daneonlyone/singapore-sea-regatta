    ...
    <>
      <div className="mt-8 max-w-2xl glass rounded-3xl p-3 sm:p-4">
        <button onClick={() => setOpen(true)} className="group relative block w-full overflow-hidden rounded-2xl" aria-label="Expand festival map">
          <Image src="https://media.base44.com/images/public/6a635ab4e57d550e514135e7/879614e95_Gemini_Generated_Image_c7zjimc7zjimc7zj.jpg" originWidth={1023} originHeight={791} fittingType="fit" className="w-full rounded-2xl" alt={ALT} />
